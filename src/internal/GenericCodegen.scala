...
trait GenericCodegen extends BlockTraversal {
  ...
  def emitSource[T: Typ: Nul, R: Typ: Nul](f: Exp[T] => Exp[R], className: String, stream: PrintWriter): List[(Sym[Any], Any)] = {
    val s = fresh[T]
    val body = reifyBlock(f(s))
    emitSource(List(s), body, className, stream)
  }

  def emitSource2[T1: Typ: Nul, T2: Typ: Nul, R: Typ: Nul](f: (Exp[T1], Exp[T2]) => Exp[R], className: String, stream: PrintWriter): List[(Sym[Any], Any)] = {
    val s1 = fresh[T1]
    val s2 = fresh[T2]
  ...
  def emitSource3[T1: Typ: Nul, T2: Typ: Nul, T3: Typ: Nul, R: Typ: Nul](f: (Exp[T1], Exp[T2], Exp[T3]) => Exp[R], className: String, stream: PrintWriter): List[(Sym[Any], Any)] = {
    val s1 = fresh[T1]
    val s2 = fresh[T2]
    val s3 = fresh[T3]
  ...
  def emitSource4[T1: Typ: Nul, T2: Typ: Nul, T3: Typ: Nul, T4: Typ: Nul, R: Typ: Nul](f: (Exp[T1], Exp[T2], Exp[T3], Exp[T4]) => Exp[R], className: String, stream: PrintWriter): List[(Sym[Any], Any)] = {
    val s1 = fresh[T1]
    val s2 = fresh[T2]
    val s3 = fresh[T3]
    val s4 = fresh[T4]
  ...
  def emitSource5[T1: Typ: Nul, T2: Typ: Nul, T3: Typ: Nul, T4: Typ: Nul, T5: Typ: Nul, R: Typ: Nul](f: (Exp[T1], Exp[T2], Exp[T3], Exp[T4], Exp[T5]) => Exp[R], className: String, stream: PrintWriter): List[(Sym[Any], Any)] = {
    val s1 = fresh[T1]
    val s2 = fresh[T2]
    val s3 = fresh[T3]
    val s4 = fresh[T4]
   ...
   */
  def emitSource[A: Typ: Nul](args: List[Sym[_]], body: Block[A], className: String, stream: PrintWriter): List[(Sym[Any], Any)] // return free static data in block
  ...
  def isPrimitiveType[A](m: Typ[A]) : Boolean = {
    m.toString match {
  ...
  def isVoidType[A](m: Typ[A]) : Boolean = {
    m.toString match {
      case "Unit" => true
      case _ => false
    }
