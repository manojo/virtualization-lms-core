...
trait ArrayLoops extends Loops with OverloadHack { this: PrimitiveOps =>
  ...
  def array[T: Typ: Nul](shape: Rep[Int])(f: Rep[Int] => Rep[T]): Rep[Array[T]]
  def sum(shape: Rep[Int])(f: Rep[Int] => Rep[Double]): Rep[Double] // TODO: make reduce operation configurable!
  def arrayIf[T: Typ: Nul](shape: Rep[Int])(f: Rep[Int] => (Rep[Boolean],Rep[T])): Rep[Array[T]]
  def sumIf(shape: Rep[Int])(f: Rep[Int] => (Rep[Boolean],Rep[Double])): Rep[Double] // TODO: make reduce operation configurable!
  def flatten[T: Typ: Nul](shape: Rep[Int])(f: Rep[Int] => Rep[Array[T]]): Rep[Array[T]]

  def infix_at[T: Typ: Nul](a: Rep[Array[T]], i: Rep[Int]): Rep[T]
  def infix_length[T: Typ: Nul](a: Rep[Array[T]]): Rep[Int]
}


trait ArrayLoopsExp extends LoopsExp { this: PrimitiveOpsExp =>
  implicit def arrayTyp[T: Typ: Nul]: Typ[Array[T]] = typ[T].arrayTyp
  ...
  def infix_at[T: Typ: Nul](a: Rep[Array[T]], i: Rep[Int]): Rep[T] = ArrayIndex(a, i)

  def infix_length[T: Typ: Nul](a: Rep[Array[T]]): Rep[Int] = a match {
  ...
  override def mirrorFatDef[A: Typ: Nul](e: Def[A], f: Transformer)(implicit pos: SourceContext): Def[A] = (e match {
