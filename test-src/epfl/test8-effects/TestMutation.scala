...
trait ArrayMutation extends ArrayLoops with PrimitiveOps {
  ...
  def infix_update[T: Typ: Nul](a: Rep[Array[T]], i: Rep[Int], x: Rep[T]): Rep[Unit]

  def infix_mutable[T: Typ: Nul](a: Rep[Array[T]]): Rep[Array[T]]
  def infix_clone[T: Typ: Nul](a: Rep[Array[T]]): Rep[Array[T]]
...
trait ArrayMutationExp extends ArrayMutation with PrimitiveOpsExp with ArrayLoopsExp {
  ...
  def infix_update[T: Typ: Nul](a: Rep[Array[T]], i: Rep[Int], x: Rep[T]) = reflectWrite(a)(ArrayUpdate(a,i,x))

  def infix_mutable[T: Typ: Nul](a: Rep[Array[T]]) = reflectMutable(ArrayMutable(a))
  def infix_clone[T: Typ: Nul](a: Rep[Array[T]]) = ArrayClone(a)
